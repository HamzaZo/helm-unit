...
| `isEmpty` |<font color='#ff0055'>values</font> A set of values to validate. <br/><font color='#1a75ff'>path</font> The path to assert<br/> |map<br>string| Assert the value of the specified **path** is empty| <pre>type: isEmpty <br/>values:<br/>- path: spec.template.spec.containers[0].securityContext</pre> |
